...
st.write('다중선형회귀 모형')
st.write('- 종속변수(y)가 k개의 독립변수들(x1, x2, ... xk)과 어떻게 관련되어 있는지를 분석하기 위해 사용되는 모형')
...
dataset = read_file("276ml/276CSS.csv")
# dataset = pd.read_csv('276CSS.csv', dtype={"사업자번호": str}) 로컬 테스트용
